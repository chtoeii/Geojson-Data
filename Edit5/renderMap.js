...
function Map(props) {
  ...
  const pipecolor = {
    ...
    loadModules(["esri/views/MapView", "esri/WebMap", "esri/layers/GeoJSONLayer", "esri/layers/MapImageLayer", "esri/layers/FeatureLayer", "esri/widgets/Search", "esri/widgets/LayerList", "esri/widgets/CoordinateConversion", "esri/widgets/Locate", "esri/widgets/ElevationProfile", "esri/layers/ImageryLayer", "esri/WebScene", "esri/views/SceneView", "esri/widgets/Legend"], {
      css: true
    }).then(([MapView, WebMap, GeoJSONLayer, MapImageLayer, FeatureLayer, Search, LayerList, CoordinateConversion, Locate, ElevationProfile, ImageryLayer, WebScene, SceneView, Legend]) => {
